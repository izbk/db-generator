...
public class MainOracle {
	public static void main(String[] args) throws Exception {
		...
		ftUtil.generateFile("/", "template.xml", map, "D:/", "oracle.doc");
	}
	...
	public static List<Map<String, Object>> getColumnList(Connection conn, String tableName) throws SQLException {
		...
		String sql = "SELECT utc.table_name,utc.column_name,utc.data_type,utc.data_length,utc.data_default,utc.nullable,ucc.comments,p.PRIMARY_KEY "
				+ "FROM  user_tab_columns utc " + "LEFT JOIN user_col_comments ucc " + // --查询注释
				"ON utc.table_name = ucc.table_name " + "AND  utc.column_name = ucc.column_name " + "LEFT JOIN " + // --查询主键
				...
				+ "WHERE con.constraint_name = col.constraint_name " + "AND con.constraint_type = 'P') p "
				+ "ON utc.column_name = p.column_name " + "AND p.table_name = utc.table_name "
